...
const breastpatientSchema = new mongoose.Schema({
  ...
  isUnderMedicationForBreast: { type: Boolean, required: true },
  isUnderBloodTransfusionForBreast: { type: Boolean, required: true },
  familyHistoryForBreast: { type: Boolean, required: true },
  UID: { type: String },
