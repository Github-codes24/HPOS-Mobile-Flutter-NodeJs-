...
const patientSchema = new mongoose.Schema({
  ...
  centerName: { type: String, required: true },
  isUnderMedicationForSickle: { type: Boolean, required: true },
  isUnderBloodTransfusionForSickle: { type: Boolean, required: true },
  familyHistoryForSickle: { type: String, required: true },
  UID: { type: String },
